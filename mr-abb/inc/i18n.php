...
function mrabb_arabic_strings() {
	return array(
		...
		'Hello,' => 'أهلاً،',
		'What would you like to accomplish today?' => 'عايز تنجز إيه النهارده؟',
		'AI Tools' => 'أدوات الذكاء',
		'Smart Shortcuts' => 'اختصارات ذكية',
		'Connected Tools' => 'الأدوات المتصلة',
		'Manage' => 'إدارة',
		'AI Assistant' => 'المساعد الذكي',
		'How can I help you' => 'أقدر أساعدك في إيه',
		'today?' => 'النهارده؟',
		...
		'actions this week vs last' => 'إجراءات الأسبوع ده مقارنة باللي فات',
		'Score' => 'النقاط',
		'Full week' => 'الأسبوع كله',
		'All' => 'الكل',
		...
		'Summarize your meeting' => 'لخص اجتماعك',
		'Email Assistant' => 'مساعد الإيميل',
		'Draft professional email' => 'اكتب إيميل احترافي',
		'Pipeline Review' => 'مراجعة الفرص',
		'Opportunities and risks' => 'الفرص والمخاطر',
		'Plan My Day' => 'خطط يومي',
		'Schedule & prioritize' => 'جدولة وترتيب أولويات',
		'Talk to Mr. Abb' => 'اتكلم مع مستر عب',
		'Navigation' => 'التنقل',
		'Today' => 'النهارده',
	);
}
